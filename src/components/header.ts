class HeaderComponent extends HTMLElement {
  ...
  render() {
    this.innerHTML =`
    <header class="flex w-90 h-15 gap-24.5 justify-center items-center bg-nike-white">
    ...
    <section class="sidebar block w-77.5 h-full p-2 bg-nike-white top-0 right-[-310px] peer-checked:right-0 z-20 fixed transition-all duration-350 [header:has(#menu:checked)+&]:right-0">
      ...
      <div class="flex gap-5 pl-8.5 pt-19">
        <button class="w-22.5 h-10 rounded-full bg-nike-black text-nike-white text-base"><a href="./sign-up.html">가입하기</a></button>
        <button class="w-19.5 h-10 rounded-full bg-nike-white text-nike-black border border-nike-gray-light text-base"><a href="./sign-in.html">로그인</a></button>
      </div>
